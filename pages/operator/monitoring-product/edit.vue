<template>
  <div>
    <v-card 
      ...
      <v-row align="center">
        <v-col cols="3">
          <b class="text-uppercase">Nama Alat</b>
        </v-col>
        <v-col cols="9">
          <v-text-field
            v-model="tool_name"
      ...
      <v-row align="center">
        <v-col cols="3">
          <b class="text-uppercase">Kode Produk</b>
        </v-col>
        <v-col cols="9">
          <v-text-field
      ...
      <v-row align="center">
        <v-col cols="3">
          <b class="text-uppercase">Kode Lokasi</b>
        </v-col>
...
<script>
export default {
  name: "OperatorProductEdit",
  layout: "operator",
  data() {
    return {
      calender:false,
      tool_name:"Name here",
      product_code:"XPRO0101",
